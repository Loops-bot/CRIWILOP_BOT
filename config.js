...
global.owner = [
  ['573244488043', '⍣ᴄʀɪᴡɪʟᴏᴘ࿐', true],
  ['59897030099', '️⍣ᴠɪᴄᴛᴏʀ ᴇᴍᴀɴᴜᴇʟ࿐', true],
]
global.mods = [] 
global.prems = [] 
//╰─────────────────────╯
...
global.ignyc = '\n⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n⍣ᴄʀɪᴡɪʟᴏᴘ࿐\n' 
global.wm = '\n⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n⍣ᴄʀɪᴡɪʟᴏᴘ࿐\n' 
global.botname = '⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐'
global.me = '⍣ᴄʀɪᴡɪʟᴏᴘ࿐'
//╰─────────────────────╯


//᭥🥗᭢━━━━━━◜𝑻𝑬𝑿𝑻𝑶𝑺◞━━━━━━᭥🥗᭢
global.adimagen = `🌅| Iᴍᴀ́ɢᴇɴᴇs Bʏ ⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐🌿` 
global.adanime = `🌸| Aɴɪᴍᴇ Bʏ ⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐🈴` 
global.adyoutube = `🍁| Dᴇsᴄᴀʀɢᴀs ᴅᴇ YᴏᴜTᴜʙᴇ🍄` 
global.adsticker = `🏞️| Sᴛɪᴄᴋᴇʀs Bʏ ⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐🌺` 
global.addescargas = `📤| Dᴇsᴄᴀʀɢᴀs Bʏ ⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐🌸`
 //╰─────────────────────╯
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n⍣ᴄʀɪᴡɪʟᴏᴘ࿐', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
//╰─────────────────────╯
//᭥🌺᭢━━━━◜𝑮𝑰𝑭 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━━᭥🌺᭢
global.fgif = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`*⍣ᴄʀɪᴡɪʟᴏᴘ࿐*`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n      ⍣ᴄʀɪᴡɪʟᴏᴘ࿐`, 'jpegThumbnail': imgfgif }}}
//╰─────────────────────╯
//᭥🌺᭢━━━━◜𝑨𝑼𝑫𝑰𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━━᭥🌺᭢
...
global.fdocument = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n   ⍣ᴄʀɪᴡɪʟᴏᴘ࿐`,jpegThumbnail: catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑰𝑴𝑨𝑮𝑬𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━━━᭥🌺᭢
global.fakeimg = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"imageMessage": { "title":`*⍣ᴄʀɪᴡɪʟᴏᴘ࿐*`, "h": `Hmm`,'seconds': '99999', 'imagePlayback': 'true', 'caption': `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n    ⍣ᴄʀɪᴡɪʟᴏᴘ࿐`, 'jpegThumbnail': catalogo }}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑴𝑬𝑵𝑺𝑨𝑱𝑬 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fakemsg = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335-1625305606@g.us" } : {}) }, message: { "extendedTextMessage": { "text":'⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n⍣ᴄʀɪᴡɪʟᴏᴘ࿐', "title": '⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐', 'jpegThumbnail': catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━◜𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━᭥🌺᭢
global.flocation = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n   ⍣ᴄʀɪᴡɪʟᴏᴘ࿐`,jpegThumbnail: catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑽𝑰́𝑫𝑬𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":`⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐`, "h": `Hmm`,'seconds': '2022', 'caption': `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐`, 'jpegThumbnail': catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑳𝑰𝑵𝑲𝑮𝑷 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "Alberto", "caption": `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐\n      ⍣ᴄʀɪᴡɪʟᴏᴘ࿐`, 'jpegThumbnail': catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━᭥🌺᭢
global.fproducto = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335@s.whatsapp.net" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐`, "description": "NyanCatBot-MD", "currencyCode": "USD", "priceAmount1000": "200000000", "retailerId": "Ghost", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑳𝑰𝑽𝑬 𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵◞━━━᭥🌺᭢
global.liveloc = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false  ? { remoteJid: "status@broadcast" } : {}) }, message: { "liveLocationMessage": { "caption":"⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐","h": `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐`, 'jpegThumbnail': catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶 2◞━━᭥🌺᭢
global.fproducto2 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "status@broadcast" } : {})}, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": `⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐`, "retailerId": "⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑽𝑰𝑬𝑾𝑶𝑵𝑪𝑬 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━᭥🌺᭢
...
//᭥🌄᭢━━━━━◜𝑨𝑫 𝑫𝑬 𝑮𝑹𝑼𝑷𝑶◞━━━━━᭥🌄᭢
global.adgp = { contextInfo: { externalAdReply: { showAdAttribution: true, title: '⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐', body: global.botname, sourceUrl: global.linkgc, thumbnail: miniurl }}}
//╰─────────────────────╯
